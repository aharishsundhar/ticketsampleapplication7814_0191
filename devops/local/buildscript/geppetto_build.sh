...
APPLICATION='/ticketsampleapplication7814'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7814-desktop:1.0'
...
helm install --name ticketsampleapplication7814-0191 ./helm
if [ $? -eq 0 ]; then
